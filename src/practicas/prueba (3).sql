...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-01-2024 a las 11:36:01
...
--
-- Estructura de tabla para la tabla `cond_perma`
--

CREATE TABLE `cond_perma` (
...
--
-- Indices de la tabla `cond_perma`
--
ALTER TABLE `cond_perma`
...
--
-- Filtros para la tabla `cond_perma`
--
ALTER TABLE `cond_perma`
